...
class Predicting(object):
    ...
    def predict(self):
        ...
        roc_curves_dic = roc_curves(labels_all, logits_prob_all, self.args.labels, save_path = self.args.output_dir)
        
        # Add information to testing history
        history['roc_curves_dic'].append(roc_curves_dic)
        ...
        history_savepath = os.path.join(self.args.output_dir,
                                        'test_'+self.args.model.split('.')[0]+'.pickle')
